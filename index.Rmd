...
At present, I maintained three servers. You can choose any server among followings. Please find the nearest server and enjoy the app.
...
Yes. You can run this app in your computer. You need the R and RStudio installed in your computer.
Install the shiny package and run the followong R code.
