              ...
              tabPanel("ggplot2",
                       fluidPage(
                         fluidRow(
                           ...
                           hr(),
                           column(4,wellPanel(
                             fileInput("file", label="Upload data(*.xlsx,*.csv)"),
                             ...
                             actionButton("resetVar",div(id="reset"))
                             
                           )),
                           column(8,wellPanel(
                                  checkboxInput('doPreprocessing','데이타 전처리하기',value=FALSE),
...
명령어를 고칠때는 체크박스를 해제하고 고친후 다시 체크하세요\n',rows=7,width=510),
                                  ...
                                  selectInput3("example","예제갤러리",
                                              c("None"=0,"Diamonds Are Forever"=21,
                                                ...
                                                "산점도에 라벨붙이기*"=51,
                                                "산점도에 라벨붙이기(중복체크)*"=52,
                                                "geom_count예제*"=53),selected=0,width=250),
                                  ...
                                  conditionalPanel(
                                    ...
                                    fluidRow(
                                      column(12,wellPanel(  
                                        selectInput3("sortvar1","정렬기준 열1",c("None"),selectize=TRUE,multiple=TRUE,width=200),
                                        selectInput3("sortvar2","정렬기준 열2",c("None"),selectize=TRUE,multiple=TRUE,width=200),
                                        actionButton("sort","열 정렬하기"),
                                        br(),
                                        checkboxInput3("desc1","내림차순",value=FALSE,width=200),
                                        checkboxInput3("desc2","내림차순",value=FALSE,width=200),
                                        br(),
                                        br(),
                                        textInput3("filtercondition","필터 조건",value="",width=400),
                                        actionButton("filter","필터 적용하기"),
                                        br(),
                                        br(),
                                        selectInput3("selectcol","선택할 열",c("None"),selectize=TRUE,multiple=TRUE,width=200),
                                        actionButton("select","열 일부 선택하기")
                                  ...
                                  conditionalPanel(
                                    ...
                                    fluidRow(
                                      column(12,wellPanel(  
                                        ...
                                        br(),
                                        textInput3("colnameadd","행번호 열 이름 입력",value="id",width=150),
                                  ...
                                  conditionalPanel(
                                    ...
                                    fluidRow(
                                    column(8,wellPanel(  
                                      selectInput("id.var","아이디로 사용할 변수(들)을 선택하세요","",selectize=TRUE,multiple=TRUE),
                                      selectInput("measure.vars","측정변수들을 선택하세요(생략시 모두)","",selectize=TRUE,multiple=TRUE),
                                      textInput("variable.name","새로 만드는 변수 이름을 선택하세요",value="variable"),
                                      textInput("value.name","값을 저장할 이름을 입력하세요",value="value"),
                                      textInput("newdata","새로 만들 데이타프레임의 이름을 입력하세요",value="dat")
                                    )),  
                                  ...
                                  conditionalPanel(
                                    ...
                                    fluidRow(
                                      column(8,wellPanel(  
                                        ...
                                        selectInput("groupvar1","그룹으로 나눌 변수를 선택하세요",c("None"),multiple=TRUE,selectize=TRUE)
                         ...
                         checkboxInput("showtable","자료테이블 항상 보이기",value= FALSE),
                         tableOutput("table"),
                         ...
                         fluidRow(
                          column(3,
                             ...
                             selectInput3("labeller","면분할라벨:",c("label_value","label_both","label_context","label_parsed","label_wrap_gen"),selectize=TRUE,selected="label_value",width=140),
                             selectInput3("facetswitch","면분할switch:",c("None","x","y","both"),selectize=TRUE,selected="None",width=140),
                             ...
                             numericInput2("facetwrapncol","ncol",value=0,step=1,min=0,width=60),
                             checkboxInput3("strip.bg.blank","면분할라벨배경제거",value=FALSE,width=140)
                          ...
                          column(6,wellPanel(
                             ...
                             conditionalPanel(
                               ...
                               wellPanel( 
                                 checkboxInput('geom_label','use geom_label instead gem_text',value=FALSE),
                                 br(),
                                 selectInput3('textstat','stat',c("identity","bin"),selected="identity"),
...
#                                  ), 
                             ...
                             conditionalPanel( 
                               ...
                               wellPanel(
                                 selectInput3("smoothmethod", label = "method",
                                              ...
                                              selected ="loess"),
                                 selectInput3("smoothformula", label = "formula(선택)",
                           ...
                           column(3,#wellPanel(
                             ...
                             checkboxInput3("coordfixed","축 비율 고정하기",value=FALSE,width=140),
                             conditionalPanel( 
                               condition="input.coordfixed==true",
                               textInput3('coordratio','ratio',value=1,width=140)
                             ),
                             checkboxInput3("coordmap","coord_map",value=FALSE,width=140),
                             conditionalPanel( 
                             ...
                             checkboxInput3("axis.blank","축제목라벨모두없애기",value=FALSE,width=140),
                       ...
                       fluidRow(
                          ...
                          column(6,
                                 ...
                                 textareaInput('rorder','ggplot2 명령어 입니다.',rows=8,width=403)
                          ),
                          column(6,
                                 wellPanel(    
                                   h4("plot 크기조절"),
